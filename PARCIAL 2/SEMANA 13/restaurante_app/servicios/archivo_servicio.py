...
# de archivos JSON (productos.json y usuarios.json) utilizando el módulo estándar
# `json` y manejando las excepciones específicas de I/O.
...
class ArchivoServicio:
    ...
    def guardar_datos(self, ruta_archivo: str, lista_dicts: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            print(
                f"  [ERROR DE PERMISOS] No se pudo guardar en '{ruta_archivo}'."
            )
            return False
        except OSError as err:
            print(
