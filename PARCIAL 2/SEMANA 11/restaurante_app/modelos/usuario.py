# -*- coding: utf-8 -*-
# modelos/usuario.py
# Semana 11 — Persistencia JSON completada para Usuario.
#
...
class Usuario:
    ...
    En la Semana 11 incorpora métodos to_dict() y from_dict() para permitir
    su almacenamiento y reconstrucción desde el archivo usuarios.json.
    """
